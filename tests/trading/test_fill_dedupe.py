...
from cryptoscreener.trading.contracts import FillEvent
...
class TestOtherContractDedupeKeys:
    ...
    def test_order_intent_dedupe_key(self) -> None:
        ...
        from cryptoscreener.trading.contracts import OrderIntent
    ...
    def test_order_ack_dedupe_key(self) -> None:
        ...
        from cryptoscreener.trading.contracts import OrderAck
    ...
    def test_position_snapshot_dedupe_key(self) -> None:
        ...
        from cryptoscreener.trading.contracts import PositionSnapshot
    ...
    def test_session_state_dedupe_key(self) -> None:
        ...
        from cryptoscreener.trading.contracts import SessionState
    ...
    def test_risk_breach_dedupe_key(self) -> None:
        ...
        from cryptoscreener.trading.contracts import RiskBreachEvent
